...
//        /// </summary>
//        public TSPRouter(RouterBase router, Profile profile, Coordinate[] locations, int first = 0, int? last = null, SolverBase<float, TSProblem, TSPObjective, Itinero.Optimization.Tours.Tour, float> solver = null,
