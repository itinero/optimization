...
//        /// </summary>
//        public STSPRouter(RouterBase router, Profile profile, Coordinate[] locations, float max, int first = 0, int? last = null, SolverBase<float, STSProblem, STSPObjective, Itinero.Optimization.Tour, STSPFitness> solver = null,
...
//        private SolverBase<float, STSProblem, STSPObjective, Itinero.Optimization.Tour, STSPFitness> _solver;
...
//            {
//                _route = new Itinero.Optimization.Tour(_originalRoute.Select(x => _weightMatrixAlgorithm.LocationIndexOf(x)),
