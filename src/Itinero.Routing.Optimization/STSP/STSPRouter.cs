...
namespace Itinero.Routing.Optimization.STSP
{
    ...
    public class STSPRouter : AlgorithmBase
    {
        ...
        /// </summary>
        public STSPRouter(RouterBase router, Profile profile, Coordinate[] locations, float max, int first = 0, int? last = null, SolverBase<float, STSProblem, STSPObjective, Itinero.Optimization.Routes.Route, STSPFitness> solver = null,
        ...
        private SolverBase<float, STSProblem, STSPObjective, Itinero.Optimization.Routes.Route, STSPFitness> _solver;
