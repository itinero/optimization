...
namespace Itinero.Optimization.Solvers.TSP_D.HillClimbing3Opt
{
    ...
    internal sealed class HillClimbing3OptSolver : Strategy<TSPDProblem, Candidate<TSPDProblem, Tour>>
    {
        ...
        /// Creates a new solver.
        /// </summary>
        public HillClimbing3OptSolver(Strategy<TSPDProblem, Candidate<TSPDProblem, Tour>> generator, bool nearestNeighbours = true, bool dontLook = true)
        {
        ...
        public override Candidate<TSPDProblem, Tour> Search(TSPDProblem problem)
        {
            ...
            var nearestNeighbours = _nearestNeighbours ? problem.NearestNeighbourCache.GetNNearestNeighboursForward(10) : null;
