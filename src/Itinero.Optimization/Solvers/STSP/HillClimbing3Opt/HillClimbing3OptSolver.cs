...
namespace Itinero.Optimization.Solvers.STSP.HillClimbing3Opt
{
    ...
    /// - Use don't look bits.
    /// </remarks>
    internal sealed class HillClimbing3OptSolver : Strategy<STSProblem, Candidate<STSProblem, Tour>>
    {
        private readonly Strategy<STSProblem, Candidate<STSProblem, Tour>> _generator;
        ...
        /// Creates a new solver.
        /// </summary>
        public HillClimbing3OptSolver(Strategy<STSProblem, Candidate<STSProblem, Tour>> generator, bool nearestNeighbours = true, bool dontLook = true)
        {
