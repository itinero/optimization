...
namespace Itinero.Optimization.Abstract.Solvers.VRP.Capacitated
{
    ...
    /// </summary>
    public static class CVRPSolverDetails
    {
        /// <summary>
        ...
        /// </summary>
        public static Result<CVRProblem> TryToCVRP(this AbstractModel model)
        {
            // check if the model is valid.
            string reasonWhenFailed;
            if (!model.IsCVRP(out reasonWhenFailed))
            {
                return new Result<CVRProblem>("Model is not a No-Depot VRP: " +
                    reasonWhenFailed);
            }
            ...
            return new Result<CVRProblem>(problem);
        }
        ...
        /// <returns></returns>
        public static bool IsCVRP(this AbstractModel model)
        {
            string reasonIfNot;
            return model.IsCVRP(out reasonIfNot);
        }
        ...
        /// <returns></returns>
        public static bool IsCVRP(this AbstractModel model, out string reasonIfNot)
        {
