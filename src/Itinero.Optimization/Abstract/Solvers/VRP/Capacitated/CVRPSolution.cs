...
namespace Itinero.Optimization.Abstract.Solvers.VRP.Capacitated
{
    ...
    /// </summary>
    public class CVRPSolution : MultiTour, IRelocateSolution, IExchangeSolution, IMultiExchangeSolution, IMultiRelocateSolution
    {
        ...
        /// </summary>
        public CVRPSolution(int size) : base(size)
        {
        ...
        /// </summary>
        protected CVRPSolution(IEnumerable<SubTour> first, int[] nextArray, List<Solvers.CapacityExtensions.Content> contents)
        ...
        {
            return new CVRPSolution(_subtours, _nextArray, _contents);
        }
    }
}