...
//     /// </summary>
//     public class SeededLocalizedCheapestInsertionSolver : SolverBase<float, CVRProblem, CVRPObjective, CVRPSolution, float>
//     {
...
//         private readonly Func<CVRProblem, IList<int>, int> _selectSeed; // hold the select seed function.
...
//         public SeededLocalizedCheapestInsertionSolver(Func<CVRProblem, IList<int>, int> selectSeed, 
//             Delegates.OverlapsFunc<CVRProblem, ITour> overlaps, int k = 10, float slackPercentage = 5, 
...
//             _interImprovements.Add(new MultiExchangeOperator<CVRPObjective, CVRProblem, CVRPSolution>(2, 10));
...
//         {
//             // create the solution.
//             var solution = new CVRPSolution(problem.Weights.Length);
...
//         /// </summary>
//         private void Improve(CVRProblem problem, CVRPObjective objective, CVRPSolution solution, int newTourIdx)
//         {
//             // the current route.
...
//         /// </summary>
//         private void TryPlaceRemaining(CVRProblem problem, CVRPObjective objective, CVRPSolution solution, List<int> visits)
//         {
//             var succes = true;
//             Func<int, float> lambdaCostFunc = null;
