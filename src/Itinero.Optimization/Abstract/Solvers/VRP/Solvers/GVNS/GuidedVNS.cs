...
namespace Itinero.Optimization.Abstract.Solvers.VRP.Solvers.GVNS
{
    ...
    /// </summary>
    public class GuidedVNS<TProblem, TObjective, TSolution, TPenalty> : SolverBase<float, TProblem, TObjective, TSolution, float>
        ...
        where TPenalty : class, new()
    {
        ...
        public GuidedVNS(SolverBase<float, TProblem, TObjective, TSolution, float> solver,
            IOperator<float, TSP.ITSProblem, TSP.TSPObjective, ITour, float> intraImprovement, 
