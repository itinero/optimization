...
namespace Itinero.Optimization.Abstract.Solvers.VRP.Operators.Exchange
{
    ...
    /// </summary>
    public interface IExchangeObjective<TProblem, TSolution>
        where TProblem : IExchangeProblem
    {
        ...
        /// <returns></returns>
        bool TrySwap(TProblem problem, TSolution solution, int t1, int t2, Triple visit1, Triple visit2, out float delta);
    }
}