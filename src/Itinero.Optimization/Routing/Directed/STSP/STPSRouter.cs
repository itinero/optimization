...
namespace Itinero.Optimization.Routing.Directed.STSP
{
    ...
    public class STSPRouter : AlgorithmBase
    {
        ...
        public STSPRouter(RouterBase router, Profile profile, Coordinate[] locations, float max, int first = 0, int? last = null,
            SolverBase<float, STSProblem, STSPObjective, Itinero.Optimization.Tours.Tour, STSPFitness> solver = null, IWeightMatrixAlgorithm<float> weightMatrixAlgorithm = null)
        {
            _router = router;
