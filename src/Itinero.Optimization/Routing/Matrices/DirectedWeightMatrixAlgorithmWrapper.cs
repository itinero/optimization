...
namespace Itinero.Optimization.Routing.Matrices
{
    ...
    /// </summary>
    public sealed class DirectedWeightMatrixAlgorithmWrapper : IDirectedWeightMatrixAlgorithm
    {
        ...
        /// </summary>
        public DirectedWeightMatrixAlgorithmWrapper(DirectedWeightMatrixAlgorithm weightMatrixAlgorithm)
        {
        ...
        /// </summary>
        public EdgePath<float>[] SourcePaths
        {
            get
            {
                return _weightMatrixAlgorithm.SourcePaths;
            }
        }
        ...
        /// </summary>
        public EdgePath<float>[] TargetPaths
        {
            get
            {
                return _weightMatrixAlgorithm.TargetPaths;
            }
        }
