...
namespace Itinero.Optimization.TSP.TimeWindows
{
    ...
    public class TSPTWRouter : AlgorithmBase
    {
        ...
        /// </summary>
        public TSPTWRouter(RouterBase router, Profile profile, Coordinate[] locations, TimeWindow[] windows, int first = 0, int? last = null,
        ...
        private SolverBase<float, TSPTWProblem, TSPTWObjective, Itinero.Optimization.Tours.Tour, float> _solver;
        ...
        protected override void DoRun()
        {
            ...
            { // the last customer was set.
                ...
                problem = new TSPTWProblem(_weightMatrixAlgorithm.IndexOf(first), _weightMatrixAlgorithm.IndexOf(_last.Value),
                    _weightMatrixAlgorithm.Weights, _windows);
            }
            else
            { // the last customer was not set.
                problem = new TSPTWProblem(_weightMatrixAlgorithm.IndexOf(first), _weightMatrixAlgorithm.Weights, _windows);
            }
