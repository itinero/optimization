...
namespace Itinero.Optimization.TSP.TimeWindows
{
    ...
    public sealed class TSPTWRouter : AlgorithmBase
    {
        ...
        private Itinero.Optimization.Tours.Tour _tour = null;
        ...
        protected override void DoRun()
        {
            ...
            { // the last customer was not set.
                problem = new TSPTWProblem(_weightMatrixAlgorithm.IndexOf(first), _weightMatrixAlgorithm.Weights, windows);
            }
