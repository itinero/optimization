...
namespace Itinero.Optimization.TSP.TimeWindows.Solvers
{
    ...
    /// </summary>
    public sealed class RandomSolver<TObjective> : SolverBase<float, TSPTWProblem, TObjective, Route, float>
        where TObjective : ObjectiveBase<TSPTWProblem, Route, float>
    {
        ...
        /// </summary>
        /// <returns></returns>
        public sealed override Route Solve(TSPTWProblem problem, TObjective objective, out float fitness)
        {
