...
namespace Itinero.Optimization.TSP.Solvers.Operators
{
    ...
    public class Local1Shift : IOperator<float, TSProblem, TSPObjective, Route, float>
    {
        ...
        /// </summary>
        /// <returns></returns>
        public bool Apply(TSProblem problem, TSPObjective objective, Route route, out float delta)
        {
                ...
                { // the middle customer of each triple is a candidate for re-insertion.
                    ...
                    { // each pair is a candidate to recieve the candidate customers.
                        ...
                        { // this candidate may fit here.
                            var localDelta = ShiftAfter.If(problem.Weights, route, triple.Along, pair.From, triple.From, triple.To, pair.To);
