...
namespace Itinero.Optimization.Test.TSP.TimeWindows
{
    ...
    public class TSPTWFeasibleObjectiveTests
    {
        ...
        public void TestNoWindows()
        {
            ...
            Assert.AreEqual(0, objective.Calculate(problem, new Optimization.Abstract.Tours.Tour(new int[] { 0, 1, 2, 3, 4 })));
        }
        ...
        public void TestWindowsOneInvalid()
        {
            ...
            // calculate objective function.
            var objective = new TSPTWFeasibleObjective();
            Assert.AreEqual(1, objective.Calculate(problem, new Optimization.Abstract.Tours.Tour(new int[] { 0, 1, 2, 3, 4 })));
        }
