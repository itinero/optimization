...
namespace Itinero.Optimization.Test.TSP.TimeWindows.Solvers.Operators
{
    ...
    public class Local1ShiftTimeWindowTests
    {
        ...
        public void TestOneShiftViolatedBackward()
        {
            ...
            var route = new Optimization.Abstract.Tours.Tour(new int[] { 0, 1, 2, 3, 4 }, 0);
            ...
            // create a route with one shift.
            route = new Optimization.Abstract.Tours.Tour(new int[] { 0, 4, 1, 3, 2 }, 0);
            ...
            route = new Optimization.Abstract.Tours.Tour(new int[] { 0, 2, 4, 1, 3 }, 0);
        ...
        public void TestOneShiftViolatedForward()
        {
            ...
            // create a route with one shift.
            var route = new Optimization.Abstract.Tours.Tour(new int[] { 0, 1, 3, 2, 4 }, 0);
            ...
            // create a feasible route.
            route = new Optimization.Abstract.Tours.Tour(new int[] { 0, 3, 1, 2, 4 }, 0);
