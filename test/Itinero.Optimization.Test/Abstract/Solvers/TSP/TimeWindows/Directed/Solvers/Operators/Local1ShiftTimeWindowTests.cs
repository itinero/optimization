...
namespace Itinero.Optimization.Test.TSP.TimeWindows.Directed.Solvers.Operators
{
    ...
    public class Local1ShiftTimeWindowTests
    {
        ...
        public void TestOneShiftViolatedBackward()
        {
            ...
            var route = new Optimization.Abstract.Tours.Tour(new int[] { 0, 4, 8, 12, 16 }, 0);
            ...
            var delta = 0.0f;
            Assert.IsTrue(localSearch.MoveViolatedBackward(problem, objective, route, out delta)); // shifts 8 after 0.
            ...
            // create a route with one shift.
            route = new Optimization.Abstract.Tours.Tour(new int[] { 0, 16, 4, 12, 8 }, 0);
            ...
            Assert.AreEqual(new int[] { 0, 8, 16, 4, 12 }, route.ToArray());

            // create a feasible route.
            route = new Optimization.Abstract.Tours.Tour(new int[] { 0, 8, 16, 4, 12 }, 0);
        ...
        public void TestOneShiftViolatedForward()
        {
            ...
            // create a route with one shift.
            var route = new Optimization.Abstract.Tours.Tour(new int[] { 0, 4, 12, 8, 16 }, 0);
            ...
            // create a feasible route.
            route = new Optimization.Abstract.Tours.Tour(new int[] { 0, 12, 4, 8, 16 }, 0);
