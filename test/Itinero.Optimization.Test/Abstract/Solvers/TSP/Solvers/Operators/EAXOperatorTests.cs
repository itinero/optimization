...
namespace Itinero.Optimization.Test.TSP.Solvers.Operators
{
    ...
    public class EAXOperatorTests
    {
        ...
        public void Test5CrossOverFixed()
        {
            ...
            // create solutions.
            var solution1 = new Optimization.Abstract.Tours.Tour(new int[] { 0, 1, 2, 3, 4 }, 4);
            var solution2 = new Optimization.Abstract.Tours.Tour(new int[] { 0, 1, 3, 2, 4 }, 4);
        ...
        public void Test5CrossOverClosed()
        {
            ...
            // create solutions.
            var solution1 = new Optimization.Abstract.Tours.Tour(new int[] { 0, 1, 2, 3, 4 }, 0);
            var solution2 = new Optimization.Abstract.Tours.Tour(new int[] { 0, 1, 3, 2, 4 }, 0);
        ...
        public void Test5CrossOverOpen()
        {
            ...
            // create solutions.
            var solution1 = new Optimization.Abstract.Tours.Tour(new int[] { 0, 1, 2, 3, 4 }, null);
            var solution2 = new Optimization.Abstract.Tours.Tour(new int[] { 0, 1, 3, 2, 4 }, null);
