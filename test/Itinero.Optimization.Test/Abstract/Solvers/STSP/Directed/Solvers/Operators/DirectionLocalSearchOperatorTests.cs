...
using Itinero.Optimization.Abstract.Solvers.STSP.Directed.Solver.Operators;
...
namespace Itinero.Optimization.Test.STSP.Directed.Solvers.Operators
{
    ...
    public class DirectionLocalSearchOperatorTests
    {
        ...
        public void TestOpen()
        {
            ...
            var route = new Optimization.Abstract.Tours.Tour(new int[] { 0, 4, 9, 12, 16 }, null);
        ...
        public void TestOpenFixed()
        {
            ...
            // create a route with one shift.
            var route = new Optimization.Abstract.Tours.Tour(new int[] { 0, 4, 9, 12, 16 }, 16);
        ...
        public void TestClosed()
        {
            ...
            // create a route with one shift.
            var route = new Optimization.Abstract.Tours.Tour(new int[] { 0, 4, 9, 12, 16 }, 0);
