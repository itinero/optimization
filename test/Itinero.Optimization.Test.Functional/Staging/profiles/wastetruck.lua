-- wastetruck globals
name = "wastetruck"
vehicle_types = { "vehicle", "motor_vehicle", "motorcar", "hgv", "psv" }
...
speed_profile = {
	["motorway"] = { speed = 90, access = true, canstop = false },
	["motorway_link"] = { speed = 90, access = true, canstop = false },
	["trunk"] = { speed = 70, access = true, canstop = false },
	["trunk_link"] = { speed = 70, access = true, canstop = false },
	["primary"] = { speed = 70, access = true, canstop = true },
	["primary_link"] = { speed = 70, access = true, canstop = true },
	["secondary"] = { speed = 70, access = true, canstop = true },
	["secondary_link"] = { speed = 70, access = true, canstop = true },
	["tertiary"] = { speed = 70, access = true, canstop = true },
	["tertiary_link"] = { speed = 70, access = true, canstop = true },
	["unclassified"] = { speed = 50, access = true, canstop = true },
	["residential"] = { speed = 50, access = true, canstop = true },
	["service"] = { speed = 30, access = true, canstop = true },
	["services"] = { speed = 30, access = true, canstop = true },
	["road"] = { speed = 30, access = true, canstop = true },
	["track"] = { speed = 30, access = true, canstop = true },
	["living_street"] = { speed = 5, access = true, canstop = true },
	["ferry"] = { speed = 5, access = true, canstop = true },
	["movable"] = { speed =  5, access = true, canstop = true },
	["pedestrian"] = { speed =  5, access = false, canstop = true }
}
...
function factor_and_speed (attributes, result)
	 ...
	 if highway_speed then
        ...
        result.direction = 0
		result.canstop = highway_speed.canstop
	...
	-- check for island tags.
	local island = attributes[name .. "_island"];
	if island == "yes" then
