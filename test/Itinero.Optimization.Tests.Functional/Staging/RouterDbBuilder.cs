    ...
    public static class RouterDbBuilder
    {
        ...
        public static RouterDb Build(string queryName, Vehicle vehicle)
        {
            ...
            if (routerDb == null)
            {
                ...
                // build routerdb.
                Itinero.Logging.Logger.Log($"{typeof(RouterDbBuilder)}.{nameof(Build)}", Itinero.Logging.TraceEventType.Information, 
                    "No existing RouterDb file found, creating now.");
                ...
                Itinero.Logging.Logger.Log($"{typeof(RouterDbBuilder)}.{nameof(Build)}", Itinero.Logging.TraceEventType.Information, "RouterDb file created.");
