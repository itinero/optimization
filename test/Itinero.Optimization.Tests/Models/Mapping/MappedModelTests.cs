...
namespace Itinero.Optimization.Tests.Models.Mapping
{
    public class MappedModelTests
    {
        ...
        public void MappedModel_ToJsonShouldReturnDefaultJson()
        {
            ...
            Assert.Equal("{\"TravelCosts\":[{\"Metric\":\"time\",\"Costs\":[[0.0,1.0],[2.0,3.0]],\"Directed\":false}],\"Visits\":[{\"Latitude\":1.01,\"Longitude\":1.02,\"TimeWindow\":{\"Min\":-3.40282347E+38,\"Max\":3.40282347E+38,\"IsUnlimited\":true},\"VisitCosts\":[{\"Metric\":\"time\",\"Value\":100.0}]},{\"Latitude\":2.01,\"Longitude\":2.02,\"TimeWindow\":{\"Min\":-3.40282347E+38,\"Max\":3.40282347E+38,\"IsUnlimited\":true},\"VisitCosts\":[{\"Metric\":\"time\",\"Value\":200.0}]}],\"VehiclePool\":{\"Vehicles\":[{\"Metric\":\"time\",\"Profile\":\"car\",\"Departure\":null,\"Arrival\":null,\"TurnPentalty\":0.0,\"CapacityConstraints\":[{\"Metric\":\"weight\",\"Capacity\":100.0}]}],\"Reusable\":false}}",
                json);
        }
    }
}