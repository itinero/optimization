...
namespace Itinero.Optimization.Tests.Solvers.STSP
{
    public class GASolverTests
    {
        ...
        /// </summary>
        [Fact]
        public void GASolver_NameShouldBeGAStrategyName()
        {
            Assert.Equal("GA_[3OHC_(NN)_(DL)_EMPTY_EX_TOURN]", GASolver.Default.Name);
        }
        ...
        /// </summary>
        [Fact]
        public void GASolver_OpenShouldGenerateRandomSequenceUnderMax()
        {
            // create problem.
            var problem = STSPHelper.Create(0, 10, 10, 40);

            for (var i = 0; i < 100; i++)
            {
                // generate solution.
                var candidate = GASolver.Default.Search(problem);
        ...
        /// </summary>
        [Fact]
        public void GASolver_OpenFixedShouldGenerateRandomSequenceUnderMax()
        {
            // create problem.
        ...
        /// </summary>
        [Fact]
        public void GASolver_ClosedShouldGenerateRandomSequenceUnderMax()
        {
            // create problem.
        ...
        /// </summary>
        [Fact]
        public void GASolver_ShouldOnlyUseProvidedVisits()
        {
            var problem = STSPHelper.Create(0, 0, 10, 10, 40,
                new int[] { 0, 2, 4, 6, 8 });

            // solve problem.
            var solution = GASolver.Default.Search(problem);
