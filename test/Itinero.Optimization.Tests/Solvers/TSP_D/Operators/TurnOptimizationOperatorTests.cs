...
{
    public class TurnOptimizationOperatorTests
    {
        [Fact]
        public void TurnOptimizationOperator_ShouldImproveOrDoNothingOnOpen()
        {
            // create problem.
            ...
            for (var t = 0; t < 100; t++)
            {
                ...
                if (TurnOptimizationOperator.Default.Apply(candidate))
                {
        ...
        [Fact]
        public void TurnOptimizationOperator_ShouldPreserveVisitsOnOpen()
        {
            // create problem.
            var problem = new TSPDProblem(0, null, WeightMatrixHelpers.BuildDirected(5, 10), 2);
        ...
        [Fact]
        public void TurnOptimizationOperator_ShouldImproveOrDoNothingOnClosed()
        {
            // create problem.
            var problem = new TSPDProblem(0, null, WeightMatrixHelpers.BuildDirected(5, 10), 2);
        ...
        [Fact]
        public void TurnOptimizationOperator_ShouldPreserveVisitsOnClosed()
        {
            // create problem.
            var problem = new TSPDProblem(0, null, WeightMatrixHelpers.BuildDirected(5, 10), 2);
        ...
        [Fact]
        public void TurnOptimizationOperator_ShouldImproveOrDoNothingOnFixed()
        {
            // create problem.
            var problem = new TSPDProblem(0, null, WeightMatrixHelpers.BuildDirected(5, 10), 2);
        ...
        [Fact]
        public void TurnOptimizationOperator_ShouldPreserveVisitsOnFixed()
        {
            // create problem.
            var problem = new TSPDProblem(0, null, WeightMatrixHelpers.BuildDirected(5, 10), 2);
